# AGENTS.md — Anesthesia Companion

Medical education platform for anesthesia students. Built with TanStack Start and deployed on Netlify.

## Project Overview

**Anesthesia Companion** — A professional dark-mode medical education SPA covering 16 anesthesia topics with interactive drug cards, emergency protocols, an interactive anesthesia machine screen, clinical cases, and personal notes.
